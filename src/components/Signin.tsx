            ...
            <div className="flex flex-row gap-3 mt-8 items-center justify-center">
              ...
              >
                ...
                >
                  <path
                    fill="#4285F4"
                    d="M533.5 278.4c0-17.4-1.4-34.1-4.1-50.3H272v95.4h146.9c-6.4 34.8-25.8 64.3-55 84.2v69.9h88.7c52.1-48 82-118.8 82-199.2z"
                  />
                  <path
                    fill="#34A853"
                    d="M272 544.3c74.7 0 137.4-24.7 183-66.9l-88.7-69.9c-24.6 16.5-56.5 26.2-94.3 26.2-72.5 0-134-48.9-155.9-114.9H23.8v72.1C69.6 487.6 165.2 544.3 272 544.3z"
                  />
                  <path
                    fill="#FBBC05"
                    d="M116.1 327.8c-10.5-31.5-10.5-65.5 0-97l-92.3-71.5C7.4 185.5 0 231.5 0 278.4s7.4 92.9 23.8 135.1l92.3-71.5z"
                  />
                  <path
                    fill="#EA4335"
                    d="M272 107.7c39.5 0 75 13.6 102.8 40.3l77.1-77.1C409.3 24.7 346.6 0 272 0 165.2 0 69.6 56.6 23.8 140.9l92.3 71.5C138 156.5 199.5 107.7 272 107.7z"
                  />
                </svg>
              </button>
            </div>
